---
author: EveryInc
description: '[BETA] Execute work with external delegate support. Same as ce-work
  but includes experimental Codex delegation mode for token-conserving code implementation.'
license: MIT
metadata:
  hermes:
    related_skills: []
